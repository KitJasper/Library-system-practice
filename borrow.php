...
<head>
    ...
    <link rel="stylesheet" href="files/borrow.css">
    <link rel="stylesheet"
                    ...
                    <form method="post">
                        <div class="in">
                                <div class="in1">
                                    ...
                                    <input type="text" class="a input" placeholder="Create Username" name="username"
                                        required>
                                    <br>
                                </div>
                                ...
                                <div class="in2">
                                    ...
                                    <input type="text" class="b input" placeholder="Create Password" name="password"
                                        required>
                                    <span class="focus-border"></span>
                                    <br>
                                </div>
